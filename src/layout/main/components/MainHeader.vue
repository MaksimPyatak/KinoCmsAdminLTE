   ...
   <nav class="main-header navbar navbar-expand navbar-dark navbar-light">
      ...
      <ul class="navbar-nav ml-auto main-header__my-office">
         <li class="nav-item main-header__my-office">
            <a
               class="nav-link main-header__avatar-link"
      ...
      <div
         v-if="compLengthMessages"
         class="main-header__upload-modal-section"
      >
         <UploadModal
            v-for="item in uploadModal.messages"
            :key="item"
            :componentsName="item.componentsName"
            :isError="item.isError"
            class="main-header__upload-modal"
         />
      </div>
   </nav>
</template>
